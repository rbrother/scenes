...
pigment
{
        image_map { jpeg "kuusi4.jpg" interpolate 2 }        
        translate <0.5,-0.5,0>
        scale <4/3,1,1>
        scale 1
}
...
pigment
{
        image_map { jpeg "kynttila.jpg" interpolate 2 }
...
#macro joulupallo(vari, pallo_koko, sijainti)
union
{
...
joulupallo(White, 0.8, <-1.5 , 1.0, 0.0> )
